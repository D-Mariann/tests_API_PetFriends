...
class PetFriends:
 ...
 JSON с уникальным ключем пользователя, найденного по указанным email и паролем"""
        ...
        try:
            ...
            result = res.text
        return status, result#api/key


    # api/pets получить список всех или своих питомцев
...
# api/create_pet_simple Добавить информацию о новом питомце без фотографии NEW
...
# api/pets/set_photo/{pet_id} добавить фото домашнего животного NEW
    ...
    # api/pets/{pet_id} удалить питомца
    ...
    # /api/pets/{pet_id} изменить питомца
